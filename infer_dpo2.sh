...
# --- 1. 静态配置 ---
# 定义检查点所在的根目录
# CKPT_ROOT_DIR="/home/zrs/skdream_model/output/dpo_origin_origin_data/"
CKPT_ROOT_DIR="/home/zrs/skdream_model/output/dpo_sft_dpo_1k_0.15"

# >>> 新增：定义输出文件夹的根目录和前缀
# 您可以修改下面的值来改变输出文件夹的名称和位置
OUTPUT_ROOT_DIR="eval/dpo_0.15"
...
# for step in $(seq 2000 200 2600); do
for step in $(seq 1000 -500 500); do
