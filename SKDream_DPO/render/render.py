...
def uv_padding(image, hole_mask, padding = 3, uv_padding_block = 4):
...
def pad_uv(ctx, mesh, resolution, uv_padding_block):
    ...
    mesh.material['kd'].data = torch.nn.Parameter(uv_padding(mesh.material['kd'].data, hole_mask, 3, uv_padding_block))
    return mesh